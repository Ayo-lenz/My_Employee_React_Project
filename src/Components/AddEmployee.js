// we want to create a button to add new employees sp we just copy what is inside the editemployee and modify it

// Creating a popup modal with React Bootstrap thats helps us edit on the homepage using props and useState hook
// the modal file was imported from React bootstrap documentation
...
function AddEmployee(props) {
  // the end goal of the work is to hit the add button and be able to add another information of employee
  ...
  return (
    <>
      <button
        onClick={handleShow}
        className="mx-auto block m-2 bg-purple-600 hover:bg-purple-700 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
      >
        + Add Employee
      </button>
